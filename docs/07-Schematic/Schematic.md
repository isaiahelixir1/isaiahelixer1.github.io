...
- Safe power input protection (fuse + reverse polarity protection)
...
- Replaced earlier multi-sensor or analog sensing approach with a single dedicated temperature sensor for:
  - Simpler firmware
  - Reduced pin usage
